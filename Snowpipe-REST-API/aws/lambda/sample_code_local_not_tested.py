...
ingest_manager = SimpleIngestManager(account='gpb49774.us-east-1',
                   host='gpb49774.us-east-1.snowflakecomputing.com',
                   user='yintingchou',
                   pipe='my_database.snowpipe.mypipe',
...
#   ...
#   ]
staged_file_list = ['small_test_data.csv']
